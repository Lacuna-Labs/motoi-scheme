# Motoi Scheme — Language Specification (Draft 1)

> **Status:** Draft 1 — 2026-07-13. Light spec, meant to give shape.
> Not a full standard. It answers "what is Motoi Scheme?" clearly
...
Motoi Scheme is a small, capability-bounded Lisp-1 that runs anywhere
...
modules for drawing, sound, animation, games, AI, and commerce. Its
...
Motoi Scheme is layered. Every REPL loads L0 unconditionally; higher
...
Every bound name in Motoi Scheme has one of five statuses. The
