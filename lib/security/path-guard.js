...
//   3. Absolute path outside the caller's ROOT set (cwd + ~/.motoi/ +
//      ~/motoi/ by default; caller may pass extra roots) → reject.
...
//   - ~/.motoi/      : install dir (shipped carts, books, reference)
//   - ~/motoi/       : user data (carts, saves, cortex, reading-state, artifacts)
