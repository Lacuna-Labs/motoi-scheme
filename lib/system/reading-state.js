...
//     each chapter render.
//   * The file lives under ~/.motoi/ next to artifacts/ so the Motoi
//     home directory is one place (`ls ~/.motoi`).
...
const MOTOI_HOME = join(homedir(), '.motoi')
const READING_STATE_PATH = join(MOTOI_HOME, 'reading-state.slat')
